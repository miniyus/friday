...
public class PasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
     ...
     * "password" : "test123"
     * }
     * 꺼낸 messageBody를 objectMapper.readValue()로 Map으로 변환 (Key : JSON의 키 -> email,
     * password)
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        PasswordAuthentication usernamePassword = objectMapper.readValue(messageBody, PasswordAuthentication.class);
