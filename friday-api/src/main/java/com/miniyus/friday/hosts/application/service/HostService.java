...
import com.miniyus.friday.hosts.application.port.in.query.RetrieveHostCommand;
import com.miniyus.friday.hosts.application.port.in.query.RetrieveHostQuery;
import com.miniyus.friday.hosts.application.port.in.usecase.*;
import com.miniyus.friday.hosts.application.port.out.CreateHostPort;
import com.miniyus.friday.hosts.application.port.out.DeleteHostPort;
import com.miniyus.friday.hosts.application.port.out.RetrieveHostPort;
import com.miniyus.friday.hosts.application.port.out.UpdateHostPort;
...
public class HostService implements CreateHostUsecase, UpdateHostUsecase, DeleteHostUsecase,
    ...
    public Host updateHost(UpdateHostCommand command) {
        var host = updateHostPort.findById(command.id()).orElseThrow(
            () -> new RestErrorException("error.host.notFound", RestErrorCode.NOT_FOUND)
        );
        ...
        return updateHostPort.updateHost(host);
    }
